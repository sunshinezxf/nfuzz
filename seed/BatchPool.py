...
from seed.BaseBatchPrioritization import BaseBatchPrioritization
...
class BatchPool:
    ...
    # constructor
    def __init__(self, seed_queue, batch_size=32, p_min=0.1, gamma=1, batch_prioritization=BaseBatchPrioritization()):
