...
"""
https://github.com/ltl7155/NPC/blob/master/LSA_DSA_ANPC_lib/neuron_coverage.py
"""
    ...
    def __init__(self, model, arc, threshold, num_classes=10, num_cluster=10):
        ...
        for cla in range(num_classes):
            ...
            for clu in range(num_cluster):
                picked_samples_fname = "cluster_paths/{}_binary_cluster/num_cluster{}_threshold{}_class{}_cluster{}_paths.pkl".format(
                    arc, num_cluster, threshold, cla, clu)
                picked_samples_fname = os.path.join(PREFIX, picked_samples_fname, )
                assert os.path.isfile(picked_samples_fname) and os.path.getsize(
                    picked_samples_fname) > 0, f"{picked_samples_fname} is empty"
